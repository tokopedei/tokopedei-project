...
const EditProduct = () => {
    ...
    const handleFileInputChange = (e) => { // Input file (img) validation
        if (e.target.files[0]) {
            if (/^.*\.(jpg|JPG|png|PNG|jpeg|JPEG)$/.test(e.target.files[0].name)) {
                ...
                e.target.setCustomValidity(`Format file yang didukung: JPG/JPEG dan PNG`);
    ...
    const isValid = () => { // Object validation function
        if (Object.keys(obj).length >= 2) {
            ...
            console.error('Tidak ada perubahan yang terdeteksi');
        }
    }
        ...
        >
            <div className='img-box'>
                ...
                <figure className='img-preview-box'>
                    ...
                    : 
                    <label htmlFor='image'>
                        <Image cloudName='df2sg0ayx'publicId={objProduct.img} title='Klik untuk memlih gambar' />
                    </label> }
                </figure>
